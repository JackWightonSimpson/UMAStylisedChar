	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 Albedo = ( tex2D( _Albedo, uv_Albedo ) * _Col ).rgb;
				float3 Normal = UnpackNormalScale( tex2D( _Normal, uv_Normal ), 1.0 );
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = saturate( ( ( 1.0 - tex2D( _Roughness, uv_Roughness ).r ) * _modsmooth ) );
				...
				float3 Transmission = ( _Transmission * _SSS ).rgb;
				float3 Translucency = ( _Translucency * _SSS ).rgb;
				#ifdef ASE_DEPTH_WRITE_ON
				float DepthValue = 0;
				#endif
...
/*ASEBEGIN
Version=18935
7;1;1906;1051;983.056;131.9248;1;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;10;-1373.385,-401.525;Inherit;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;30;-591.5555,335.8951;Inherit;False;Property;_modsmooth;mod smooth;8;0;Create;True;0;0;0;False;0;False;1;1;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;23;-568.3605,-411.8724;Inherit;False;Property;_Col;Col;5;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;18;-1061.974,518.6592;Inherit;True;Property;_AO;AO;3;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.ColorNode;21;-319.1299,594.6083;Inherit;False;Property;_Translucency;Translucency;4;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;13;-1305.785,208.1751;Inherit;True;Property;_Roughness;Roughness;2;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.ColorNode;22;-361.0295,417.4804;Inherit;False;Property;_Transmission;Transmission;6;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;28;-26.95178,214.7378;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;12;-1355.186,-55.72496;Inherit;True;Property;_Normal;Normal;1;0;Create;True;0;0;0;False;0;False;None;None;False;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
WireConnection;1;14;26;0
WireConnection;1;15;27;0
ASEEND*/
//CHKSM=F2B7BBBB33D07176D36285D08D0AE8D359BBBC4F