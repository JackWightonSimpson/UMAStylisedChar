...
Shader "Skin"
{
	Properties
	{
		...
		_AO("AO", 2D) = "white" {}
		_Col("Col", Color) = (1,1,1,0)
		[ASEEnd]_modsmooth("mod smooth", Range( 0 , 4)) = 1
		
		[DiffusionProfile]_Float1("Float 1", Float) = 2.6570491790771484[HideInInspector]_Float1_Asset("Float 1", Vector) = ( -0.000038036723708501086, -0.00000019306507681449148, 0.00001715954567771405, -206355316736 )
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.Albedo = ( tex2D( _Albedo, uv_Albedo ) * _Col ).rgb;
				surfaceDescription.Normal = UnpackNormalScale( tex2D( _Normal, uv_Normal ), 1.0 );
				...
				surfaceDescription.Smoothness = saturate( ( ( 1.0 - tex2D( _Roughness, uv_Roughness ).r ) * _modsmooth ) );
				...
				#if defined( _MATERIAL_FEATURE_SUBSURFACE_SCATTERING ) || defined( _MATERIAL_FEATURE_TRANSMISSION )
				surfaceDescription.DiffusionProfile = _Float1;
				#endif
...
WireConnection;33;8;19;1
WireConnection;33;21;45;0
ASEEND*/
//CHKSM=03AFCFF3DC01CA6441F85BE4A8D8A16539EFDB35