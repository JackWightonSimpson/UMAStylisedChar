...
_WorldHeightRange("World Height Range", Vector) = (0, 500, 0, 0)
      _PCShowProceduralIndex("Procedural Texture Index", Int) = 0
      // geotexture
   ...
   SubShader
   {
            Tags {"RenderPipeline" = "UniversalPipeline"  "RenderType" = "HDLitShader" "Queue" = "Geometry+100" "IgnoreProjector" = "False"  "TerrainCompatible" = "true" "SplatCount" = "16"}
   ...
   #pragma fragment Frag
      ...
      #define _PROCEDURALBLENDSPLATS 1
...
float3 GetTessFactors ()
{
    ...
    void SurfaceFunction(inout Surface o, inout ShaderData d)
    {
        ...
        o.Alpha = l.Alpha;
         ...
         ) : SV_Target
         {
           ...
           return float4(PackNormalOctRectEncode(TransformWorldToViewDir(mul(d.worldSpaceNormal, d.TBNMatrix), true)), 0.0, 0.0);
   ...
   Dependency "BaseMapShader" =  "Hidden/MicroSplat/Example_Base-1150669395"
   Fallback "Hidden/MicroSplat/Example_Base-1150669395"
